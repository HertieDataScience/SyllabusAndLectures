...
This is ideally a **good first run** at the data gathering and analysis for
your final project.
...
## Find confidence intervals of parameter estimates
...
Estimate model with categorical variable:
