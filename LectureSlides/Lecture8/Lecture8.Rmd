---
title: 'MPP-E1180 Lecture 8: Automatic Tables and Static Visualisation'
...
**Don't** show more digits to the right of the decimal than are statistically
...
Create **tables** and **visualisations** of **descriptive** statistics
for your final project in an R Markdown document using the techniques covered in 
class.
