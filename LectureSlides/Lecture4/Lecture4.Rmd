...
<i class="fa fa-frown-o"></i> There is no PDF version of the slides for reasons 
...
- `Watch` the [SyllabusAndLectures](https://github.com/HertieDataScience/SyllabusAndLectures) 
repo. This way you can **find each other**.
...
[Donald Knuth (1992)](http://en.wikipedia.org/wiki/Literate_programming): explanation of a program using **natural language** interspersed
