...
You can have Git ignore any file by including its file path (relative to the 
repo) in a file called *.gitignore*.

This is useful for files such as *.Rhistory* that you don't want to version 
control and which create pointless merge conflicts.

It's also useful for very large files that you can't store on GitHub.
