...
We are only going to begin scratching the surface of the data formats you are
likely to encounter.
...
# Download per country alternative energy use as % of total energy use
...
YenDollar <- quantmod::getSymbols(Symbols = 'DEXJPUS', src = 'FRED')
```
...
```{r}
messyAgain <- spread(data = tidy, key = treatement, value = result)
