...
- Public data is being made increasingly **accessible**.
...
be wrong.''](http://simplystatistics.org/2014/06/06/the-real-reason-reproducible-research-is-important/)
...
- This enables **effort duplication**.
...
- <i class="fa fa-arrow-circle-o-up"></i> **Objective**: setup software
