...
[/HertieDataScience2014/Examples/SimplePaperWithAnalysis](https://github.com/HertieDataScience2014/Examples/tree/master/SimplePaperWithAnalysis)
...
You can add a table of contents to your PDF output:
...
`fig_caption: true` attaches captions to figures (unfortunately only for PDFs).
