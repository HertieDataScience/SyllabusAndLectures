...
## <i class="fa fa-arrow-circle-o-up"></i> Objectives for Today (Part 1)
...
Use **advanced computation tools** to do **data munging**. 
...
## <i class="fa fa-sort-numeric-asc"></i> Typical Two Hour Class Plan
...
- 3 Pair Assignments (2 Oct, 23 Oct, 6 Nov)

    + 10% each

- Collaborative Research Project (Presentation: 4 Dec, Website/Paper: Exam Week)
...
- **Give me your GitHub username** so that I can add you to the **HertieDataScience**
group (<https://github.com/HertieDataScience>).
