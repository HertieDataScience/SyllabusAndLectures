...
with means $\bar{\beta}_{1\ldots k}$ and variances specified by the paramteters'
...
Monete Carlo or bootstrapping. Just differ on **how the parameters are
drawn**.
...
You can find the covariance matrix with `vcov`.
