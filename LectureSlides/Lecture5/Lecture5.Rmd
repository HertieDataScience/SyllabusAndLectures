...
BibTex allows you to create a **single database** of **all** of the **literature/packages
you cite**.
...
- Time/computationally intensive: `cache=TRUE` code chunk option: only runs the 
chunk when the **chunk code changes**.
...
Clone the [HertieDataScience2014/Examples](https://github.com/HertieDataScience2014/Examples) repo and play around with **SimplePaperWithAnalysis**. 
