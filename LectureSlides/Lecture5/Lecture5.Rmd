...
**Submbit:** A (max) 2,000 word proposal created with **RMarkdown**. The proposal
will:
...
Nerd point: YAML is a recursive acronym: ''YAML Ain't Markup Language''.
...
- `cache=TRUE` code chunk option: only runs the chunk when the **chunk code changes**.
