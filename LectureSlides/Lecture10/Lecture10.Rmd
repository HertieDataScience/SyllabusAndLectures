...
- What are some more effective ways to present results from a logistic
regression to both statistical and general audiences?
...
- A simulation plot created with Zelig or other tool showing key 
