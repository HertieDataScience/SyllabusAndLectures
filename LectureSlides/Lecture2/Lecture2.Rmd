...
Note: **not all of R's built-in data sets are data frames**. 

For Assignment 1, try to focus on data sets that are either data frames or 
matrices.
...
Test your code early and often. Do the results meet your expectations?

- Easier to find errors. 

- For an advanced discussion see [Wickham, *Testing R Packages*](http://r-pkgs.had.co.nz/tests.html).


## <i class="fa fa-arrow-circle-o-up"></i> Seminar: Start using R!

- **Save your work** in a new *.R* source file. You will need it for the next seminar.

- **Create a data frame with four columns**. The data set should have one of each:
character strings, numeric, logical, and factor variables.
